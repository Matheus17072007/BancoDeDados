...
public class NavegaFilmes extends JFrame{
    ...
    public void inicializarComponentes() {
        ...
        btMais10 = new JButton(null, new ImageIcon("icones/mais.gif"));
        btMais10.setToolTipText("+10");
        btMenos10 = new JButton(null, new ImageIcon("icones/menos.gif"));
    ...
    public void atualizarCampos() {
        try {
            ...
            tfCodigo.setText(resultSet.getString("código"));
